#!/bin/bash
# ──────────────────────────────────────────────────────────────────
#  Eval-only for cell_cond run: load ckpt, run difficulty eval (val+train) once.
#
#  Usage:
#    bash script/eval_only_discrete_diffusion_sudoku_image_diffhead_cellcond.sh
#    RESUME_DIR=/path/to/ckpt/stepNNNNN bash ...
#    OUTPUT_DIR=./runs/sudoku/<run> bash ...
# ──────────────────────────────────────────────────────────────────
...
OUTPUT_DIR=${OUTPUT_DIR:-"./runs/sudoku/discrete_diff_image_diffhead_cellcond"}
