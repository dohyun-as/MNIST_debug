...
# ── Data ──
# Local copy (was on NAS: ../clevr-dataset-gen/output/...)
CLEVR_DIR="/workspace/clevr_data/clevr_256_varied/images"
CLEVR_VAL="/workspace/clevr_data/clevr_256_varied_val/images"
...
accelerate launch \
    ...
    --backbone dit \
    --output_dir runs/clevr/backbone/out16_tokdrop${TOK_DROP} \
    --train_dir "$CLEVR_DIR" \
    --val_dir "$CLEVR_VAL" \
