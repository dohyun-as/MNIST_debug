...
OUTPUT_DIR="./outputs_discrete_diffusion/confidence_1token_2dpos"
...
# SRM_CONFIG="./config/sudoku_config.json"
# OUTPUT_DIR="./outputs_discrete_diffusion/ddpm"
...
# SRM_CONFIG="./config/sudoku_config.json"
# OUTPUT_DIR="./outputs_discrete_diffusion/confidence_resume"
...
#   --grad_accum_steps 1 \
#   --sampler confidence \
#   --resume_dir "/workspace/NAS/project/MNIST_debug/outputs_discrete_diffusion/confidence/ckpt/step80000" \
#   --tokens_per_step 1 \
# "
#   # --sampler ddpm_cache \
