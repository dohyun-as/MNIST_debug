...
#
#  Difference vs. train_discrete_diffusion_clevr_ours_text_diffhead.sh:
#    word-level CLEVR vocab encoder
#      → HF CLIPTextModel (openai/clip-vit-base-patch32), fine-tuned
#        with a separate (lower) LR — same recipe as
#        train_text_conditioned_clevr.sh.
#
#  Usage:
#    bash script/train_discrete_diffusion_clevr_ours_text_diffhead_clip.sh
#    GPUS=0,1 bash script/train_discrete_diffusion_clevr_ours_text_diffhead_clip.sh
# ──────────────────────────────────────────────────────────────────
