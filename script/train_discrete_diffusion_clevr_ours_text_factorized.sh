#!/bin/bash
# ──────────────────────────────────────────────────────────────────
#  CLEVR — Discrete Diffusion with Factorized AR Head (TokenBridge-style)
#  Same as train_discrete_diffusion_clevr_ours_text.sh but with
#  --factorized_head for per-dim prediction instead of 64K flat softmax
# ──────────────────────────────────────────────────────────────────
...
# ── Paths ──
PRETRAINED_DIR=${PRETRAINED_DIR:-"./runs/clevr/backbone/clevr_256_dit_vit_flow_fsq_mask0_CA"}
...
OUTPUT_DIR="./runs/clevr/discrete_diff_ours_text_factorized"
