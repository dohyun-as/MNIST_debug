...
#   --sampler confidence --tokens_per_step 1    # linear: 1 token/step (default)
#   --sampler confidence --tokens_per_step 0    # cosine schedule
#   --sampler ddpm_cache                        # DDPM cached
#   --sampler ddpm                              # DDPM no-cache
