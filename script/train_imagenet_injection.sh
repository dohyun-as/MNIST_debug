#!/bin/bash
# Multi-Resolution Injection Mode Training on ImageNet 256×256
# VAE: xwen99/mar-vae-kl16 (16× downsample, 16ch latent → 16×16)
#
# Usage:
#   bash script/train_imagenet_injection.sh
#   GPUS=0,1 bash script/train_imagenet_injection.sh
#
# Options:
#   --cond_use_latent : encoder에 VAE latent를 넣음 (기본: raw image)
...
accelerate launch \
    ...
    --output_dir runs/imagenet_256_large_fsq_X_zero_uncond \
