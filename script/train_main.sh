...
DATA_DIR="./data"
OUTPUT_DIR="./outputs/concat_pixel_sample_emb_debug"
...
"
  ...
  # --resume_dir "/workspace/NAS/project/MNIST_debug/outputs/concat_pixel_sample_fsq333/ckpt/step10000"
...
# DATA_DIR="./data"
# OUTPUT_DIR="./outputs/concat_pixel_sample_fsq88888"
# UNET_CONFIG="./config/unet_mnist_concat.json"
# VAE_CONFIG="./config/vae_sudoku_full.json" 
# SRM_CONFIG="./config/sudoku_config.json" 
# CLASSIFIER="/workspace/NAS/project/MNIST_debug/datasets/mnist_sudoku/mnist_classifier.pth"
...
# ──────────────────────────────────────────────────────────────────
#  ViT encoder + MAE masking (patchwise)
# ──────────────────────────────────────────────────────────────────
...
DATA_DIR="./data"
OUTPUT_DIR="./outputs/concat_vit_mae_patch"
UNET_CONFIG="./config/unet_mnist_concat.json"
SRM_CONFIG="./config/sudoku_config.json"
CLASSIFIER="/workspace/NAS/project/MNIST_debug/datasets/mnist_sudoku/mnist_classifier.pth"
