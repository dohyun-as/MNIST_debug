#!/bin/bash
# ──────────────────────────────────────────────────────────────────
#  Visualize-only pass for the SEMI-AR masked-diffusion run:
#    runs/clevr/masked_diff/ours_text_diffhead_clip_out16_tokdrop1.0_semiar
#
#  Same as visualize_only_masked_diff_generation.sh — no
#  detector/classifier eval, just generation + decode + PNGs.
#  Semi-AR is auto-activated from run_config.json.
#
#  Usage:
#    bash script/visualize_only_masked_diff_generation_semiar.sh
